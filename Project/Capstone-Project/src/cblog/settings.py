...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cnngzeuzrcxc.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesoguzhanblog' # please enter your s3 bucket name
